...
void Interface::enableWorkers()
{
  ...
  {
    m_pUtility->fdNonBlocking(m_fdPool[0], strError);
    m_pUtility->fdNonBlocking(m_fdPool[1], strError);
...
void Interface::pool()
{
  ...
  string strError, strPrefix = "Interface::pool()";
  stringstream ssMessage;
  time_t CTime;
