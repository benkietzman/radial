    ...
    <div class="table-responsive">
      <table class="table table-striped bg-danger-subtle border border-danger-subtle">
        ...
        <tr>
          ...
          <th style="background: inherit;">Compoundings (#/yr)</th>
        ...
        <tr>
          ...
          <td style="background: inherit;"><input type="text" class="form-control form-control-sm bg-danger-subtle" c-model="d.Compoundings"></td>
        ...
        <tr>
          ...
          <td style="background: inherit;">{{#ifCond @key '!=' ../k}}{{../Compoundings}}{{else}}<input type="text" class="form-control form-control-sm bg-danger-subtle" c-model="e.Compoundings">{{/ifCond}}</td>
