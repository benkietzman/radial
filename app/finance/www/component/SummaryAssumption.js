    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="row">
          ...
          <div class="col-md-auto"><div class="input-group input-group-sm" style="margin: 4px;"><span class="input-group-text">Dividend Span</span><select class="form-control" c-change="change()" c-model="d.DividendSpan"><option value="1-year">1-Year</option><option value="latest">Latest</option></select></div></div>
