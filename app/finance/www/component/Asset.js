        ...
        <div class="card-body bg-success-subtle table-responsive" style="padding: 0px;">
          <table id="stock" class="table table-striped">
            ...
            <tr>
              ...
              <td style="background: inherit; font-size: small; text-align: right;" title="{{number (multiply (divide (divide (assetStockYield Dividend DividendLatest Price) 100) (divide (assetStockYieldSum) 100)) 100)}}%">{{numberShort (multiply (divide (divide (assetStockYield Dividend DividendLatest Price) 100) (divide (assetStockYieldSum) 100)) 100)}}%</td>
              <td style="background: inherit; font-size: small; text-align: right;" title="{{number (multiply (divide (divide (assetStockYield Dividend DividendLatest Price) 100) (divide (assetStockYieldSum) 100)) (assetStockSum))}}">{{numberShort (multiply (divide (divide (assetStockYield Dividend DividendLatest Price) 100) (divide (assetStockYieldSum) 100)) (assetStockSum))}}</td>
              <td class="text-{{#ifCond (subtract (multiply Shares Price) (multiply (divide (divide (assetStockYield Dividend DividendLatest Price) 100) (divide (assetStockYieldSum) 100)) (assetStockSum))) '>=' 0}}success{{else}}danger{{/ifCond}}" style="background: inherit; font-size: small; text-align: right;" title="{{number (subtract (multiply Shares Price) (multiply (divide (divide (assetStockYield Dividend DividendLatest Price) 100) (divide (assetStockYieldSum) 100)) (assetStockSum)))}}">{{numberShort (subtract (multiply Shares Price) (multiply (divide (divide (assetStockYield Dividend DividendLatest Price) 100) (divide (assetStockYieldSum) 100)) (assetStockSum)))}}</td>
