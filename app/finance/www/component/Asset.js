        ...
        <div class="card-body bg-success-subtle table-responsive" style="max-height: 500px; padding: 0px;">
          <table id="stock" class="table table-striped">
            ...
            <tr>
              ...
              <td class="text-end {{#ifCond Age "<" 10}}text-danger{{/ifCond}}{{#ifCond Age "<" 5}} fw-bold{{/ifCond}}{{#ifCond Age "<" 2}} fw-bolder{{/ifCond}}{{#ifCond Age  "<" 1}} fst-italic{{/ifCond}}{{#ifCond Age ">=" 20}}text-success{{/ifCond}}{{#ifCond Age ">=" 30}} fw-bold{{/ifCond}}{{#ifCond Age ">=" 40}} fw-bolder{{/ifCond}}{{#ifCond Age ">=" 50}} fst-italic{{/ifCond}}" style="background: inherit;" title="{{dateyear FirstTrade}} ({{Age}})">{{dateyear FirstTrade}}</td>
