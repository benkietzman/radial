        ...
        <div class="card-body bg-success-subtle table-responsive" style="padding: 0px;">
          <table id="stock" class="table table-striped">
            ...
            <tr>
              ...
              <td style="background: inherit; font-size: small; text-align: right;" title="{{number (assetStockReceive Shares Dividend DividendLatest Receive 1 @root.a.d.Assumption.DividendSpan)}}">{{numberShort (assetStockReceive Shares Dividend DividendLatest Receive 1 @root.a.d.Assumption.DividendSpan)}}</td>
              <td style="background: inherit; font-size: small; text-align: right;" title="{{number (assetStockReceive Shares Dividend DividendLatest Receive 2 @root.a.d.Assumption.DividendSpan)}}">{{numberShort (assetStockReceive Shares Dividend DividendLatest Receive 2 @root.a.d.Assumption.DividendSpan)}}</td>
              <td style="background: inherit; font-size: small; text-align: right;" title="{{number (assetStockReceive Shares Dividend DividendLatest Receive 3 @root.a.d.Assumption.DividendSpan)}}">{{numberShort (assetStockReceive Shares Dividend DividendLatest Receive 3 @root.a.d.Assumption.DividendSpan)}}</td>
            </tr>
            {{/each}}
            </tbody>
            <tfoot>
