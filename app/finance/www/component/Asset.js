        ...
        <div class="card-body bg-success-subtle table-responsive" style="padding: 0px;">
          <table id="stock" class="table table-striped">
            ...
            <tr>
              ...
              <td style="background: inherit; font-size: small; text-align: right;" title="{{number (assetStockDividend Shares Dividend DividendLatest)}}">{{numberShort (assetStockDividend Shares Dividend DividendLatest)}}</td>
