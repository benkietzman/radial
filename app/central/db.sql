...
CREATE TABLE `application` (
  ...
  `mots` mediumint DEFAULT NULL,
  `mylogins` tinyint(1) NOT NULL DEFAULT '0',
  `mylogins_prefix` varchar(6) DEFAULT NULL,
  `nma_overload_level` int NOT NULL DEFAULT '5',
  PRIMARY KEY (`id`),
...
CREATE TABLE `application_contact` (
  ...
  `description` varchar(256) DEFAULT NULL,
  `mylogins_last_login_dt` timestamp NULL DEFAULT NULL,
  `mylogins_add_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `mylogins_mod_dt` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
